...
impl ToolboxIdlProgramRoot {
    pub fn compile_transaction_instruction(
        ...
        Ok(Instruction {
            ...
            accounts:
                ToolboxIdlProgramRoot::compile_transaction_instruction_accounts(
                    program_instruction,
                    &transaction_instruction.accounts_addresses,
                    breadcrumbs,
                )?,
            data: ToolboxIdlProgramRoot::compile_transaction_instruction_data(
                program_instruction,
    ...
    pub fn decompile_transaction_instruction(
        ...
        let program_instruction = idl_ok_or_else(
            self.guess_program_instruction(&native_instruction.data),
        ...
        Ok(ToolboxIdlTransactionInstruction {
            ...
            accounts_addresses:
                ToolboxIdlProgramRoot::decompile_transaction_instruction_accounts(
                    program_instruction,
                    &native_instruction.accounts,
                    breadcrumbs,
                )?,
            args: ToolboxIdlProgramRoot::decompile_transaction_instruction_data(
                program_instruction,
