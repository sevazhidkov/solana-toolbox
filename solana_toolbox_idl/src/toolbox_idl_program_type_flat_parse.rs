...
impl ToolboxIdlProgramTypeFlat {
    pub fn try_parse(
        ...
        if let Some(idl_object) = idl_value.as_object() {
            return ToolboxIdlProgramTypeFlat::try_parse_object(
                idl_object,
                breadcrumbs,
            );
        }
        if let Some(idl_array) = idl_value.as_array() {
            return ToolboxIdlProgramTypeFlat::try_parse_array(
                idl_array,
                breadcrumbs,
            );
        }
        if let Some(idl_str) = idl_value.as_str() {
            return ToolboxIdlProgramTypeFlat::try_parse_str(
                idl_str,
                breadcrumbs,
            );
        }
        if let Some(idl_u64) = idl_value.as_u64() {
            return ToolboxIdlProgramTypeFlat::try_parse_u64(
                idl_u64,
                breadcrumbs,
            );
        }
    ...
    fn try_parse_object(
        ...
        if let Some(idl_type) = idl_object.get("type") {
            return ToolboxIdlProgramTypeFlat::try_parse(idl_type, breadcrumbs);
        }
        if let Some(idl_defined) = idl_object.get("defined") {
            return ToolboxIdlProgramTypeFlat::try_parse_defined(
                idl_defined,
                breadcrumbs,
            );
        }
        if let Some(idl_option) = idl_object.get("option") {
            return ToolboxIdlProgramTypeFlat::try_parse_option(
                idl_option,
                breadcrumbs,
            );
        }
        if let Some(idl_vec) = idl_object.get("vec") {
            return ToolboxIdlProgramTypeFlat::try_parse_vec(
                idl_vec,
                breadcrumbs,
            );
        }
        ...
        {
            return ToolboxIdlProgramTypeFlat::try_parse_struct_fields(
                idl_struct_fields,
                breadcrumbs,
            );
        }
        ...
        {
            return ToolboxIdlProgramTypeFlat::try_parse_enum_variants(
                idl_enum_variants,
                breadcrumbs,
            );
        }
        ...
        {
            return ToolboxIdlProgramTypeFlat::try_parse_generic_symbol(
                idl_generic_symbol,
                breadcrumbs,
            );
        }
        ...
        {
            return ToolboxIdlProgramTypeFlat::try_parse_value_literal(
                idl_value_literal,
                breadcrumbs,
            );
        }
    ...
    fn try_parse_array(
        ...
        if idl_array.len() == 2 {
            return Ok(ToolboxIdlProgramTypeFlat::Array {
                items: Box::new(ToolboxIdlProgramTypeFlat::try_parse(
                    &idl_array[0],
                    &breadcrumbs.with_idl("items"),
                )?),
                length: Box::new(ToolboxIdlProgramTypeFlat::try_parse(
                    &idl_array[1],
    ...
    fn try_parse_str(
        ...
        Ok(match ToolboxIdlProgramTypePrimitive::try_parse(idl_str) {
            Some(primitive) => {
                ToolboxIdlProgramTypeFlat::Primitive { primitive }
            },
            None => ToolboxIdlProgramTypeFlat::Defined {
    ...
    fn try_parse_u64(
        ...
        Ok(ToolboxIdlProgramTypeFlat::Const {
    ...
    fn try_parse_defined(
            ...
            idl_value_as_object_get_key_as_array(idl_defined, "generics")
        {
            ...
            {
                defined_generics.push(ToolboxIdlProgramTypeFlat::try_parse(
                    idl_defined_generic,
                    &breadcrumbs,
                )?);
            }
    ...
    fn try_parse_generic_symbol(
        ...
        Ok(ToolboxIdlProgramTypeFlat::Generic {
    ...
    fn try_parse_option(
        ...
        Ok(ToolboxIdlProgramTypeFlat::Option {
            content: Box::new(ToolboxIdlProgramTypeFlat::try_parse(
                idl_option,
    ...
    fn try_parse_vec(
        ...
        Ok(ToolboxIdlProgramTypeFlat::Vec {
            items: Box::new(ToolboxIdlProgramTypeFlat::try_parse(
                idl_vec,
    ...
    fn try_parse_struct_fields(
        ...
        Ok(ToolboxIdlProgramTypeFlat::Struct {
            fields: ToolboxIdlProgramTypeFlatFields::try_parse(
                idl_struct_fields,
                breadcrumbs,
            )?,
        })
    ...
    fn try_parse_enum_variants(
            ...
            idl_iter_get_scoped_values(idl_enum_variants, breadcrumbs)?
        {
            ...
            {
                ToolboxIdlProgramTypeFlatFields::try_parse(
        ...
        Ok(ToolboxIdlProgramTypeFlat::Enum {
...
impl ToolboxIdlProgramTypeFlatFields {
    fn try_parse(
        ...
        if idl_fields.is_empty() {
            return Ok(ToolboxIdlProgramTypeFlatFields::None);
        }
            ...
            idl_iter_get_scoped_values(idl_fields, breadcrumbs)?
        {
            ...
            let field_type_flat = ToolboxIdlProgramTypeFlat::try_parse(
                idl_field,
        ...
        if !fields_named {
            ...
            Ok(ToolboxIdlProgramTypeFlatFields::Unamed(fields))
        } else {
            Ok(ToolboxIdlProgramTypeFlatFields::Named(fields_info))
        }
    }
}
